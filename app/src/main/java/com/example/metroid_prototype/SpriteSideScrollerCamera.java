...
public class SpriteSideScrollerCamera {
    ...
    public SpriteSideScrollerCamera(int camWidth, int camHeight, int lvlWidth, int lvlHeight, Player player) {
        ...
        this.y = levelHeight - cameraHeight;  // Set to bottom of level by default
    }
    ...
    public void update() {
        ...
        // this.y = clamp(target.getCenterY() - cameraHeight / 2, 0, levelHeight - cameraHeight);
    }
